enum AccessibilityIdentifier {
    ...
    static let onboardingStepProgress = "onboarding.step-progress"
    static let onboardingDefaultBrowserStep = "onboarding.step.default-browser"
    static let onboardingClipboardShortcutStep = "onboarding.step.clipboard-shortcut"
    static let onboardingContinue = "onboarding.continue"
    static let onboardingBack = "onboarding.back"
    static let onboardingClipboardShortcutToggle = "onboarding.clipboard-url.shortcut-toggle"
    static let onboardingClipboardShortcutField = "onboarding.clipboard-url.shortcut-field"
    static let onboardingClipboardShortcutStatus = "onboarding.clipboard-url.shortcut-status"
